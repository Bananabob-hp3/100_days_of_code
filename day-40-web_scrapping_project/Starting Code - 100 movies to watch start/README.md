...
Scraping the top 100 movies of all time from a website. Generatinh a text file called `movies.txt` that lists the movie titles in ascending order (starting from 1). 
